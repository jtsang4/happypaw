...
import { GROUP_SYNC_INTERVAL_MS } from './index-bootstrap-state.js';
import {
...
import { shutdownTerminals, shutdownWebServer, startWebServer } from './web.js';
...
export function createIndexBootstrap(deps: IndexBootstrapDeps): {
  start: () => Promise<void>;
} {
  const {
    activeRouteUpdaters,
