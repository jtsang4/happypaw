...
const MEMORY_FLUSH_DISALLOWED_TOOLS = [
  ...
  'mcp__happypaw__send_message',
  'mcp__happypaw__schedule_task',
  'mcp__happypaw__list_tasks',
  'mcp__happypaw__pause_task',
...
function formatTranscriptMarkdown(messages: ParsedMessage[], title?: string | null): string {
  ...
  for (const msg of messages) {
    const sender = msg.role === 'user' ? 'User' : 'HappyPaw';
